# con-x-dataplane-postgresql-vault Module

This runtime is a variant of the con-x-dataplane-postgresql-hashicorp-vault runtime, which is using the [SqlVaultExtension](../../../edc-extensions/sql-vault/README.md) instead of the EDC's HashiCorp Vault extension in order to manage the handling of certain 
...
```shell
./gradlew :edc-dataplane:edc-dataplane-construct-x:con-x-dataplane-postgres-vault:dockerize
```

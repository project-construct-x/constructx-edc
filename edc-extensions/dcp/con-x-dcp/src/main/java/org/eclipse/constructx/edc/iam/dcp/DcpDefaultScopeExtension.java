...
import static org.eclipse.constructx.edc.iam.dcp.DcpDefaultScopeExtension.NAME;
...
public class DcpDefaultScopeExtension implements ServiceExtension {
    ...
    static final String NAME = "ConstructX default scope extension";
    ...
    private Map<String, Set<String>> defaultScopes(ServiceExtensionContext context) {
        ...
        monitor.info(format("Registering construct-x default scopes %s", scopesByVersion));

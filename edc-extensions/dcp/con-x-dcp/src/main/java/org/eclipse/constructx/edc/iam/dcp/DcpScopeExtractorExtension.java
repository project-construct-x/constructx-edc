...
import org.eclipse.constructx.edc.iam.dcp.scope.CredentialScopeExtractor;
...
import static org.eclipse.constructx.edc.iam.dcp.DcpScopeExtractorExtension.NAME;

@Extension(NAME)
public class DcpScopeExtractorExtension implements ServiceExtension {
    static final String NAME = "ConstructX scope extractor extension";
